...
CREATE TABLE locations(
	location_id integer DEFAULT nextval('auto_id_location') PRIMARY KEY,
...
CREATE TABLE user_roles(
	role_id integer DEFAULT nextval('auto_id_role') PRIMARY KEY,
...
CREATE TABLE users(
	...
	user_role integer NOT NULL REFERENCES user_roles(role_id) ON DELETE RESTRICT ON UPDATE CASCADE
);
