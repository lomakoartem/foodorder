...
abstractService.factory('VendorService', ['$resource', '$q', '$timeout', 'DummyService', function ($resource, $q, $timeout, DummyService) {
    var service = {};
    var generateResource = function (address) {
        var resourceString = 'http://' + location.host + '/api/vendors/' + address;
        return $resource(resourceString, {}, {
            'get': {
                method: 'GET',
                transformResponse: function (data) {
